...
const register = async (req, res) => {
  ...
  const verifyEmail = {
    ...
    html: `<a tarhet="_blank" href="${baseUrl}/api/users/verify/${verificationToken}">Click to verify email</a>`,
  };
...
const getCurrent = async (req, res) => {
  ...
  res.json({
    user: { email, wallet, avatarURL, token },
  });
};
